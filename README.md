# Goal Getter
An Agentic AI Goal Planning Assistant that seamlessly integrates with Google Workspace and gives actionable roadmaps to keep users on track to meet their goals.
